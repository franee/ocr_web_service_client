...
Gem::Specification.new do |s|
  ...
  s.files = ["ocr_web_service_client.gemspec", "Rakefile", "test.rb", "config/ocr_web_service.yml.sample", "config/ocr_web_service.yml", "COPYING", "LICENSE", "CHANGELOG", "README", "Manifest", "lib/palmade/ocr_web_service_client.rb", "lib/palmade/ocr_web_service_client/web_service.rb", "lib/palmade/ocr_web_service_client/runner.rb", "lib/palmade/ocr_web_service_client/version.rb", "lib/palmade/ocr_web_service_client/ocr_web_service_recognize.rb", "lib/palmade/ocr_web_service_client/ocrws_setting.rb", "lib/palmade/ocr_web_service_client/ocrws_zone.rb", "lib/palmade/ocr_web_service_client/ocrws_input_image.rb"]
  s.homepage = %q{}
